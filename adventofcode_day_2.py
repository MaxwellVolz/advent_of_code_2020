# -*- coding: utf-8 -*-
"""adventofcode_day_2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Ej9yp-AG_-vgFexEOWAozwaDvlNvhW-G
"""

passwords = """3-5 f: fgfff
...
for words in passwords:
  ...
  policy, letter, pw = words.split()

  policy = policy.split('-')
  min_occurences, max_occurences = policy[0], policy[1]
  letter = letter[0]
  # print(min_occurences, max_occurences, letter, pw)

  if int(min_occurences) <= pw.count(letter) <= int(max_occurences):
    valid_password_count += 1
  # print(pw.count(letter))
...
for words in passwords:
  ...
  policy = policy.split('-')
  first_loc, second_loc = policy[0], policy[1]
  letter = letter[0]
  # print(min_occurences, max_occurences, letter, pw)
  pw = [pw[int(first_loc) - 1], pw[int(second_loc) - 1]]

  if pw.count(letter) == 1:
    valid_password_count += 1
  # print(pw.count(letter))
