# -*- coding: utf-8 -*-
"""adventofcode_day_6.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1F4DPDaGLMevEGhcI5YhseOQYM45hgCnE
"""
...
customs_data = [x.replace('\n','') for x in customs_data]
...
for group in customs_data:
  ...
  uniq_set = set(flatten(group))
  uniq_set_mutable = set(flatten(group))

  for item in group:
    for yes_answer in uniq_set:
      if yes_answer not in item and yes_answer in uniq_set_mutable:
        uniq_set_mutable.remove(yes_answer)

  all_yes_sum += len(uniq_set_mutable)
